...
public class MainActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabDiary = (FloatingActionButton) findViewById(R.id.fab_attach_diary);
        ...
        fabDiary.setOnClickListener(view -> {
            Intent intent = new Intent(this, de.rampro.activitydiary.ui.main.DiaryActivity.class);
